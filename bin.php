...
<div class="center">
	<form class="form-horizontal"name="form1" method="post" action="bin.php">
...
<pre><h3> <img src="img/logo.jpg" class="img-polaroid width="80">&nbsp;&nbsp;&nbsp;แบบฟอร์มแจ้งปัญหาหรือความต้องการให้ผู้เกี่ยวข้องดำเนินการ</h3></pre>
<br>
<div class="right"><p> <a href="admin.php">หน้าขอข้อมูล</a> </p></div>
      ...
      <td><div align="center">
		...
		<thead>
          ...
          <tr>
			...
			<td bgcolor="<?php if($status==1){echo 'red';}elseif($status==2){echo 'green';}else{echo 'gray';}?>"> <div align="center"><?php echo get_status($status); ?></div></td>
			<td><div align="center"><?php echo "<a href='recovery.php?id_select=$id'>Recovery</a>";?></div></td>
		  </tr>
          <?php } ?>
        </table>
      </div>
