    ...
    <form name="form1" method="post" action="inseart_data.php">
        ...
        <input type="hidden" name="user" value="0">
          ...
          <div class="w100 dflex">
              ...
              <div class="w80 padding10"><input type="text" id="input-form" name="department" autocomplete="off" required></div>
          </div>
          <div class="w100 dflex">
              <div class="w20 padding10 right">หมายเลขติดต่อกลับ <span class="font-red">*</span></div>
              <div class="w80 padding10"><input type="text" id="input-form" name="tel" autocomplete="off" required></div>
          </div>
          <div class="w100 dflex">
          ...
          <div class="w100 dflex">
              ...
              <div class="w80 padding10"><input type="text" id="input-form" name="name" autocomplete="off" required></div>
          </div>
          <div class="w100 dflex">
