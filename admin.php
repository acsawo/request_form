...
<div class="container">
    ...
    <nav><a href="bin.php"><button class="SteelBlue"><i class='fas fa-trash-alt' style="font-size:16px"></i> ถังขยะ</button></a> <a href="logout.php"><button class="seagreen"><i class='fa fa-sign-out' style="font-size:20px"></i> ออกจากระบบ</button></a></nav>
    <section>
